...
<html id="ctl00_html_tag" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Iperius Backup - Contact
    </title>
                        ...
                        <ul id="menu-top-menu" class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown pmd-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li role="separator" class="divider"></li>
                                    <li><a style="font-weight: bold;" href="http://www.iperiusbackup.in/contact.aspx">Become a RESELLER</a></li>
 ...
 <img src="http://iperiusbackup.in/img/logos/iperius_backup_logo_header.png" width="173" />
            ...
            <div class="header-title-bar container" style="height: auto;">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 breadcrumb">
                    <span style="font-size: 10pt;">Contact us</span>
                </div>
                    ...
                    <div class="container" id="app">
                        ...
                        <div id="pnlButtons">
                            ...
                            <p style="text-align: center; line-height: 40px;">
                                Before you submit a support request or a technical question<br />
                                <a class="btn pmd-ripple-effect btn-secondary" target="_blank" href="http://www.iperiusbackup.net">Read the TUTORIALS</a>
                            </p>
                        ...
                        <div class="col-lg-8 col-md-8 col-md-offset-2 col-lg-offset-2">
                            ...
                            <div class="pmd-card pmd-z-depth pmd-card-custom-form">
                                <div class="pmd-card-body">
                                    <!-- Bootstrap Selectbox -->
                                    <div class="form-group">
                                        <label for="regular1" class="control-label">Contact reason:</label>&nbsp;
                                        <select name="cbxMotivo" id="cbxMotivo" class="form-control" runat="server">
                                            <option selected="selected" value="">Select ...</option>
                                            <option value="Pre-sales questions / General questions">Pre-sales questions / General questions</option>
                                            <option value="Licenses - Activation / Change / Upgrade">Licenses - Activation / Change / Upgrade</option>
                                            <option value="Reseller / Partnership programs">Reseller / Partnership programs</option>
                                             <option value="Technical support / Technical questions">Technical support / Technical questions</option>
                                             <option value="Request invoice">Request invoice</option>
                                        </select>
                                    </div>
                                    <!-- Regular Input -->
                                    <div class="form-group">
                                        <label for="regular1" class="control-label">Name or Company Name:</label>
                                        &nbsp; 
                                        <asp:TextBox ID="txtNome" runat="server" Width="250px" maxlength="255" class="form-control" ValidationGroup="save" /> 
                                        <asp:RequiredFieldValidator ID="rfvtxtNome" runat="server" ErrorMessage="*" 
                                            ControlToValidate="txtNome" ValidationGroup="save" Display="Dynamic"  /> 
                                    </div>
                                    <div class="form-group">
                                        <label for="regular1" class="control-label">E-mail:</label>&nbsp;
                   
                                        <asp:TextBox ID="txtEmail" runat="server" Width="250px" maxlength="255" class="form-control" ValidationGroup="save"/>
                                        <asp:RequiredFieldValidator ID="rfvtxtEmail" runat="server" ErrorMessage="*" Display="Dynamic"
                                            ControlToValidate="txtEmail" ValidationGroup="save" /> 
                                    </div>
                                    <div class="form-group">
                                        <label for="regular1" class="control-label">Subject:</label>
                                        <asp:TextBox ID="txtOggetto" runat="server" Width="250px" maxlength="255" class="form-control" ValidationGroup="save" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"  Display="Dynamic"
                                            ControlToValidate="txtOggetto" ValidationGroup="save" />
                                    </div>
                                    <!-- Textarea -->
                                    <div class="form-group">
                                        <label class="control-label">Message:&nbsp;</label>
                                        <asp:TextBox TextMode="MultiLine" rows="2" cols="20" ID="txtMessaggio" runat="server"   maxlength="500" class="form-control" /><br />
                                    </div>

<%--                                    <input id="ckbNewsletter" type="checkbox" name="ckbNewsletter" checked="checked" /><label for="ckbNewsletter">Send me news on software updates and offers</label>
                                    <br />

                                    <input id="ckbconsenso_privacy" type="checkbox" name="ckbconsenso_privacy" /><label for="ckbconsenso_privacy">I read the privacy policy and agree with it</label>
                                    ( <a target="_blank" href="/privacy-gdpr.aspx">Read Privacy Policy</a> ) --%>

 
                                  
                                   
                                     <asp:Button ID="btnSend" OnClick="Button1_Click" ClientIDMode="Static" runat="server" Text="Send" ValidationGroup="save" />
  <br />
                                    <p style="color:green">
            ...
            <footer class="iperius-footer">
                <div class="container-fluid text-center">
                    <div class="row" style="padding-bottom: 15px; margin-bottom: 20px; padding-top: 15px; padding-left: 50px; background: #e5e5e5; padding-right: 50px;">
                        <h6 style="color: #000;">
                            <label>Iperius Backup is the ideal solution to backup and protect your important data. Iperius Backup is the software that completes your work.<br />
                                <br />
                                <a href="/contact.aspx"><b style="color: #000">Contact us</b></a>&nbsp;to talk directly to one of our experts.</label>
                        </h6>
                    </div>
                </div>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-133">
                                    <h6 class="text-uppercase">
                                        <img width="150" src="/img/logos/logo.png" /></h6>
                                </li>
...
Vadodara - 390 021 Gujarat India</li>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-3">
                            <ul class="list-inline text-left">
                                ...
                                <li><a href="http://www.iperiusbackup.in/contact.aspx">Become a Reseller</a></li>
