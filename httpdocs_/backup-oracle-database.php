...
<head><title>
	Backup software for Oracle database | Iperius Backup
</title><link rel="shortcut icon" href="/favicon.ico" /><link rel="icon" href="/favicon.ico" type="image/x-icon" />
	<link rel="canonical" href="http://www.iperiusbackup.in/backup-oracle-database.php" />
    ...
    <script type='text/javascript' src='/js/bootstrap.min.js'></script>
     ...
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="description" content="Iperius Backup is a powerful, easy to use and affordable software to back up Oracle databases to Cloud, Tape, FTP, NAS, with compression and AES encryption." /><link rel="alternate" href="https://www.iperiusbackup.co.uk" hreflang="en-GB" /><link rel="alternate" href="https://www.iperiusbackup.es" hreflang="es" />
	<!-- Google tag (gtag.js) -->
...
?>
		    ...
		    <div class="header-title-bar container" style="height:auto;">
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 breadcrumb" >                             
                            <span style="font-size:10pt;">Oracle backup</span>                             
                    </div>
...
<div class="tabContent">
	<div class="column">
		<h3>Backup Oracle database to Cloud, Tape, FTP, NAS</h3>
		<p class="text">The great benefit of choosing Iperius Backup as your backup program for Oracle, is to have many options available and many backup types. In a completely automated way, Iperius can transfer the Oracle backup to remote FTP servers, or to Google Drive, Amazon S3, Azure Storage, Dropbox or OneDrive (cloud backup). In order to obtain the maximum security in the data protection, Iperius can encrypt the backup files using the military-level AES 256-bit encryption.</p>
	</div>							
</div>

<div class="tabContent">
	<div class="column">
		<h3>Oracle hot backup (online backup)</h3>
		<p class="text">Iperius Backup can make hot backups of Oracle (online backup), while the database is open and running, without interrupting any service (ARCHIVELOG mode). All users can continue to work without problems, while Iperius perform automatic backup of the datafiles, archivelogs, and all the other configuration files needed to restore and recover the database.</p>
	</div>							
</div>

<div class="tabContent">
	<div class="column">
		<h3>Oracle backup at the most convenient price</h3>
		<p class="text">Iperius is the most convenient software to make Oracle backups, since in a single solution you have a great number of backup options, and you can protect unlimited servers and databases, locally and in the network. In a single backup program you have several methods to protect Oracle databases, from the basic RMAN backup to the VSS backup (snapshot).</p>
	</div>							
</div>

<div class="tabContent">
	<div class="column">
		<h3>Native and zip compression, AES encryption</h3>
		<p class="text">Iperius Backup is able to highly optimize backups of Oracle databases, thanks to the integrated native compression, which directly creates backup files on disk in a compressed format, the zip compression on several destinations (NAS, Cloud, FTP, tape, etc..), and the AES 256-bit data encryption.</p>
	</div>							
</div>

<div class="tabContent">
	<div class="column">
		<h3>Backup verification, email notifications, Iperius Console</h3>
		<p class="text">Iperius is not a simple database backup software. In fact, it includes several support options to optimize the execution and management of backups, such as verifying the integrity of files, sending e-mail notifications to be informed of the backup result, and the ability to have all reports in a web panel for centralized consultation.</p>
	</div>							
</div>
...
<div class="clearfix">
	...
	<div class="column large">
		<h3>Key features</h3>
		<ul class="list tick">
            <li>Backup of Oracle databases 9i, 10g, 11g</li>
            <li>Backup of Oracle XE (Express Edition)</li>
            <li>Backup of unlimited servers and databases</li>
            <li>Backup of local servers and servers in the network</li>
			<li>Automatic backups based on specific days and times</li>
			<li>Database backup verification</li>
			<li>Several backup destinations: Cloud, Tape, NAS, FTP</li>
			<li>Automatic backup of all databases or of individual databases</li>
			<li>Native compression</li>
			<li>Custom backup file names</li>
            <li>Data retention policies: possibility to keep more backup copies</li>
            <li>Advanced and automatic Rman backup</li>
		</ul>
	</div>	
